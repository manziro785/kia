            ...
            <div className={`car-text${classBtn} car-text`}>
              <div className="infocar">
                <div>
                  ...
                  запасом хода до 500 км на одной зарядке, мощностью до 400 л.с.
                  и быстрой зарядкой до 80% за 30 минут.
                </div>
                <div style={{ marginTop: "2rem" }}>
                  Созданный для впечатляющей производительности и экологической
                  чистоты, Kia EV9 идеально сочетается с турниром Kia
                  CYBERCHAMP, где передовые технологии встречаются с амбициями
                  киберспортивных чемпионов.
                </div>
              </div>
              <div id="abs3">
