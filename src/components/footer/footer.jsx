          ...
          <div className="footer-main">
            ...
            <div className="contacts">
              <div className="cont">
                ...
                <div style={{ cursor: "pointer" }} onClick={handleCopyGmail}>
                  +996 708 032 662
                </div>
                {Copied && (
                  <div className="wrapper-message">
              ...
              <div className="socials-link">
                <div>
                  <a href="https://www.youtube.com/@kiamotors5613">
                    <img src={icon} alt="" />
                  </a>
                </div>
                <div>
                  <a href="https://www.facebook.com/kia.bishkek/">
                    <img src={icon2} alt="" />
                  </a>
                </div>
                <div>
                  <a href="https://www.instagram.com/kiakyrgyzstan/">
                    <img src={icon3} alt="" />
                  </a>
                </div>
              </div>
